...
UI.prototype.soruGoster = function (soru) {
  ...
  title.classList.add("qestion-title");
...
UI.prototype.soruSayisiniGoster = function (soruSirasi, toplamSoruSayisi) {
  const etiket = `<span class="badge text-bg-danger">${soruSirasi} / ${toplamSoruSayisi}</span>`;
  document.querySelector(".question-index").innerHTML = etiket;
};

UI.prototype.scoruGoster = function (dogruCevap, toplamSonuc) {
  const etiket = `Toplam ${toplamSonuc} sorudan ${dogruCevap} doğru cevap verdiniz.`;
